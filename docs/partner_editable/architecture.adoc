...
** A Linux bastion host in an Auto Scaling group to allow inbound Secure Shell (SSH) access to Darktrace vSensor instances in the private subnets.*
...
* A Network Load Balancer to distribute monitored VPC traffic to Darktrace vSensor instances in the private subnets.
