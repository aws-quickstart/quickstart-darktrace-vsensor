...
* A Traffic mirroring session to send mirrored traffic to a Network Load Balancer.
* A Network Load Balancer to distribute VPC traffic to Darktrace vSensor instances.
* An Amazon Simple Storage Service (Amazon S3) bucket to store packets captured by Darktrace vSensor.
